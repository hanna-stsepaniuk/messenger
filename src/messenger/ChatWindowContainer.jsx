...
import { loadMessages, sendMessage } from '../api/messeges';
import { pushMessageAction, setMessagesAction } from '../redux/actions/messengerActions';
import { getMesseges, getSelectedFriendId } from '../redux/selectors/messengerSelectors';
...
const ChatWindowContainer = () => {
    ...
    const messages = useSelector(getMesseges(selectedFriendId));
    ...
    const onSubmit = ({ messageText }, { resetForm }) =>
        sendMessage(selectedFriendId, messageText)
            .then(() => dispatch(pushMessageAction(selectedFriendId, {
                messageText,
